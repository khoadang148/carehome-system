...
export default function SelectPackagesPage() {
  ...
  const { data: assignmentMap, refetch: fetchAssignmentMap, isFetching: isFetchingAssignmentMap } = useResidentsAssignmentStatus(residents);
  ...
  useEffect(() => {
    setLoadingAssignmentStatus(Boolean(isFetchingAssignmentMap));
  }, [isFetchingAssignmentMap]);

...
export default function SelectPackagesPage() {
  ...
  // When residents list changes, indicate status is loading until fresh map arrives
  useEffect(() => {
  ...
  const filteredAndSortedResidents = useMemo(() => {
    ...
    let filtered = residents.filter(resident => {
      ...
      // If assignment status is still loading, don't show yet to prevent overcount

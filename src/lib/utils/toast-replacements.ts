...
export const commonErrors = {
  ...
  capacityFull: (capacity: number) => `Hoạt động này đã đạt sức chứa tối đa (${capacity} người). Không thể thêm thêm người cao tuổi.`,
  ...
  serviceExists: 'người cao tuổi đã có gói này đang hoạt động hoặc chờ duyệt!',
  ...
  loadResidentsError: 'Không thể tải danh sách người cao tuổi tham gia hoạt động này.',
  ...
  selectStaffAndResidents: 'Vui lòng chọn nhân viên và ít nhất một người cao tuổi',
  invalidStaffId: 'ID nhân viên không hợp lệ',
  invalidResidentId: 'ID người cao tuổi không hợp lệ',
  alreadyAssignedResidents: (names: string) => `Các người cao tuổi sau đã được phân công cho nhân viên này rồi: ${names}. Vui lòng bỏ chọn các người cao tuổi này hoặc chọn nhân viên khác.`,
  residentAlreadyAssigned: (name: string) => `người cao tuổi ${name} đã được phân công cho nhân viên này rồi. Vui lòng chọn người cao tuổi khác hoặc nhân viên khác.`,

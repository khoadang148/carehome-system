...
export default function ServicesPage() {
  ...
  useEffect(() => {
    ...
    carePlansAPI.getAll()
      .then((data) => {
        // Sắp xếp: gói chính (main) lên đầu, sau đó là gói bổ sung
        const sortedData = data.sort((a: any, b: any) => {
          if (a.category === 'main' && b.category !== 'main') return -1;
          if (a.category !== 'main' && b.category === 'main') return 1;
          return 0;
        });
        setCarePlans(sortedData);
      })
      .catch(() => {
    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          ) : filteredCarePlans.map((pkg: any, index: number) => (
            <div
              key={pkg._id}
              style={{
                background: 'linear-gradient(135deg, #ffffff 0%, #f8fafc 100%)',
      ...
      <ConfirmModal
        ...
        title={successMessage.includes('✅') ? 'Thành công' : 'Thành công'}

...
import { CalendarDaysIcon, ArrowLeftIcon, ChevronDownIcon, ChevronUpIcon } from '@heroicons/react/24/outline';
          ...
          <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-emerald-100">Tổng cộng có {groupVisitHistory([...visitHistory], residents).length} lịch hẹn đã được tạo</p>
              </div>
            </div>
          </div>
